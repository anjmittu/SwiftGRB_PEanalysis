...
# split data
xtrain,xtest,ytrain,ytest = cross_validation.train_test_split(xall,yall,test_size=0.20)
...
if cv:
	...
	ofp = open('RF_gridsearch_scores_12.txt','w')
...
if cv:
	...
	RF3 = tree.DecisionTreeClassifier(min_samples_split=4,max_features=5, max_depth=3)
...
# save best trees
#savefile1 = open('RandomForest_500tree_NewData_4_5.pkl','w')
