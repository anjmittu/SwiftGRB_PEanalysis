...
rf_anj_on = np.loadtxt('../support_data/splines_detection_fraction_RF_old_and_new_z10000.txt')

fig, ax = plt.subplots(1)
#fig2, ax2 = plt.subplots(1)

ax.plot(rf_graff[0::10,0],rf_graff[0::10,1],'-r',lw=2,label="Graff RF")
ax.plot(rf_anj_v2[0::10,0],rf_anj_v2[0::10,1],'-b',lw=2,label="RF redo")
ax.plot(rf_anj_on[0::10,0],rf_anj_on[0::10,1],'-g',lw=2,label="RF old mixed with new")
