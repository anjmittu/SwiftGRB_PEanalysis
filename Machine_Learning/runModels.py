...
filename = "newdata/Swift_new_data3.txt"
#filename = "newdata/newDataCombined.txt"
...
if opts.RF:
	...
	savefile1a = open('RandomForest_grid_newData2.pkl','w')
	savefile1b = open('RandomForest_best_newData2.pkl','w')
