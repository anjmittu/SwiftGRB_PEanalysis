...
newDet = np.loadtxt('support_data/splines_detection_fraction_RF_old_and_new_z10000.txt')
z = nn[:,0]
...
ax[0].plot(newDet[:,0],newDet[:,1],'-y',lw=2,label="new")
ax[0].grid()
...
ax[1].plot(newDet[:,0],newDet[:,1],'-y',lw=2,label="new")
ax[1].grid()
